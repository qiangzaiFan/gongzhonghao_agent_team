...
日运标题采用 `十二星座每日好运丨YYYY.MM.DD`，按火象、土象、风象、水象分四组覆盖全部 12 个星座。该栏目使用独立的 `daily_fortune` 质检 profile，保留 3 个标题版本、2 个开头版本和编辑记录；正文为原创提醒，不复用外部文章句子、段落或图片。
...
`daily_fortune` 面向十二星座日运：标题 14-36 个可见字符，正文 700-1400 个中文字符，4 个二级小标题（火象、土象、风象、水象）和 14-16 个正文段落。
