...
5. 文章要像真人编辑后的公众号稿：只保留一个核心矛盾，语言自然、有节奏、少套话，不平均分配段落篇幅。
6. 不要提供规避平台检测的技巧；目标是提升原创度和可读性。
7. 不新增“朋友/读者/咨询对象”等虚构人物，不把想象场景冒充真人经历。
...
- 固定加粗 1 处，必须来自人物现场对话或具体物件，不提炼普适金句。
...
## 禁用表达
每个人都值得被爱、时间会治愈一切、我们应该认识到、综上所述、由此可见、正确的做法是、这告诉我们、在这个快节奏时代、你有没有发现、请相信、愿每一个女孩。
