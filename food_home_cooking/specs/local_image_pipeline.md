...
- 最终输出固定 `1536x1024`，公众号家常饭近景、手机随手拍感。食物和餐具应占画面主体，大约 70%-85%；只保留少量浅色桌面或厨房台面背景，不要让水槽、窗户、橱柜和大面积空台面抢主体。
- 单个图位只描述一个明确场景；步骤图只出现一个锅或一个碗中的单一状态。
- 整餐图必须强化局部物体约束：文章点名的主食、配菜和饮品都要清楚可见，颜色、份量、容器、火候和调味状态不能被模型替换或弱化。局部细节要自然、有食欲，不能死板摆拍。比如豆浆应是乳白色不透明饮品；拌黄瓜要用正常小菜盘，并能看到少量蒜末、醋汁油光、盐渍水光、芝麻或辣椒点缀等自然调味线索；煎玉米要玉米粒分明、金黄、有轻微焦痕，但不能大片糊黑。
