...
Illustration scene:
a phone resting quietly at the edge of a table while a simple warm dinner is still steaming, peaceful boundary.
...
2. Save that base art as:
   images/illustrations/sources/20260730_children_03_closing_base.png
3. Run:
